...
**`extract_stock_split_data()`** (`Depotkonto.py:853`)
- Parses stock split information from Kapitalmaßnahme documents
- Extracts split ratio (e.g., "1:2" → multiplier 3.0)
- Calculates new shares added
