...
"""
    ...
    def _format_html_table_row(self, cells: List[str], style: str = "", is_header: bool = False) -> str:
        """Formatiert eine HTML-Tabellenzeile"""
        tag = "th" if is_header else "td"
        style_attr = f' style="{style}"' if style else ''
        row_style = f' style="{style}"' if style and not is_header else ''
    ...
    def _create_html_link(self, text: str, url: str) -> str:
...
"""
        ...
        # Rest of the HTML generation will be added here
        # For now, close the HTML document
